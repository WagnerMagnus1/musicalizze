                    ...
                    <div class="row">
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <tbody><br>
                <?php if($atividade[0]['integrante_atividade_status']=='4'){?>
                      <center><p id="semquebralinha"><?php echo $atividade[0]['banda_nome']?></p> <h4 id="semquebralinha">RECUSOU</h4><p id="semquebralinha"> a sua notificação para participar dessa atividade.</p><br></center><br>
                       <label class="control-label" for="exampleInputPassword1">Justificativa:</label>
                       <textarea id="contrato" class="form-control" rows="3" disabled="disabled"><?php echo $atividade[0]['integrante_atividade_justificativa']?></textarea>
                <?php }else{?>
                    <?php if($atividade[0]['integrante_atividade_status']=='5'){?>
                       <center><p id="semquebralinha"><?php echo $atividade[0]['banda_nome']?></p> <h4 id="semquebralinha">ACEITOU</h4><p id="semquebralinha"> participar dessa atividade.</p><br></center><br>
                    <?php }?>
                <?php }?>
                            </tbody>
                            </table><br><hr>
                          ...
                          <script>
                            $('#visualizado').click(function() {
                                ...
                                $.ajax({            
                                    ...
                                    datatype: 'json',
                                    url: "<?php echo site_url('atividade/visualizado_reposta_banda'); ?>",      
