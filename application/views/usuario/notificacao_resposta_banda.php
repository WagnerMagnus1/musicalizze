              ...
              <div class="container">
                    ...
                    <div class="row">
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <tbody><br>
                <?php if($banda[0]['integrante_status']=='4'){?>
                      <center><p id="semquebralinha"><?php echo $banda[0]['pessoa_nome']?></p> <h4 id="semquebralinha">RECUSOU</h4><p id="semquebralinha"> a sua notificação para participar na banda.</p><br></center><br>
                ...
                <?php }else{?>
                    <?php if($banda[0]['integrante_status']=='5'){?>
                       <center><p id="semquebralinha"><?php echo $banda[0]['pessoa_nome']?></p> <h4 id="semquebralinha">ACEITOU</h4><p id="semquebralinha"> participar na banda.</p><br></center><br>
                    <?php }?>
                <?php }?>
                            </tbody>
                            </table><br><hr>
